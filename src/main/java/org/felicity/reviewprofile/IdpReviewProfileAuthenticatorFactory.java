...
public class IdpReviewProfileAuthenticatorFactory implements AuthenticatorFactory {
    ...
    public String getReferenceCategory() {
        return "reviewInstituteAndProfile";
    }
    ...
    public String getDisplayType() {
        return "Review Institute and Profile";
    }

    @Override
    public String getHelpText() {
        return "User reviews and updates profile and institute data retrieved from Identity Provider in the displayed form";
    }
